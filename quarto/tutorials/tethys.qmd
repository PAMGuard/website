...
dispord: 1
description: "This tutorial will introduce the PAMGaurd-Tethys interface, show you how to export data from PAMGuard to Tethys, and view the data with the Tethys web client."
...
[Raw audio data](https://research-portal.st-andrews.ac.uk/en/datasets/dclde-2013-workshop-dataset) from the St Andrews university research portal.
