...
PAMGuard saves it's configuration in special configuration files, ending in .psfx. Each file contains the list of [modules](../coremodules.html) and displays you've chosen to use and the settings for each module.
...
You should also visit the [tutorials pages](../tutorials.html) which will show you how to build your own configurations.
