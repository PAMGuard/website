...
The tutorial text is in [Introduction to Sound Traps.pdf](./staticmonfiles/Introduction%20Sound%20Traps%202024-v2-02-13.pdf). You will also need to download the accompanying dataset from Zenodo [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.13880212.svg)](https://doi.org/10.5281/zenodo.13880212)
