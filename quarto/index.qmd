...
<a href="downloadsurvey.html" class="btn btn-primary btn-sm" role="button" data-toggle="tooltip" title="Go straight to downloads page" style="background-color: #4CAF50;
          ...
          font-weight: bold;
          border-radius: 12px;
          width: 300px; "> <i class="fas fa-download" style="margin-right: 8px;"></i> Download PAMGuard </a> 
<a href="funding.html" class="btn btn-primary btn-sm" role="button" data-toggle="tooltip" title="Help support PAMGuard with a charitable donation" 
