...
The PAMGuard batch processing module V1.6 is now available for download
on our [plugins pages](../plugins/plugins.qmd).
...
The batch processing module is one of three major developments currently being funded
by the US [Bureau of Oceans Energy Management](https://www.boem.gov/) (BOEM):
