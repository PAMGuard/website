...
PAMGuard Tutorials are an excellent way to familiarise yourself with PAMGuard. If you're new to PAMGuard, you should start with one of the introductory turotials, [Getting Started](./tutorials/getstarted.qmd), or [Introduction to PAMGuard](./tutorials/staticmonitoring.qmd) before trying the more advanced ones.
