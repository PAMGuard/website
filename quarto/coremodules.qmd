...
If you're new to PAMGuard, start at the [Tutorials page](./tutorials/tutorials.qmd) which will help you get going.
...
| Scroll Effort | Up to 1 | Enables an observer to enter their name and information about which displays are being monitored |
...
| Noise Monitor | Any | Measures noise in predefined frequency bands (e.g. third octave) |
...
| Matched Template Click Classifier | Any | Classifies clicks based on an ideal template to match and a template to reject. An example of this is to classify beaked whale clicks in an environment with dolphin clicks |
