...
description: "Allows you to run the same PAMGuard configuration on multiple datasets, running a user defined number
  of jobs concurrently until all are complete"
---
