...
Users wishing to further process PAMGuard output data in a more flexible programming environment (for example, to develop or run bespoke classifiers on PAMGuard detections, or to make nicer plots for publication), will need to read those data into their programming language of choice.
...
Libraries are provided to read data from PAMGuard binary files written in <a href="https://www.r-project.org/" target="matlab">R</a> and <a href="https://uk.mathworks.com/products/matlab.html" target="matlab">MATLAB</a>. A <a href="https://www.python.org/" target="matlab">Python</a> library is under development. Read below how to install and use these libraries or go to the [full tutorial](tutorials/matlabrpython.qmd).
...
PAMGuard has a powerful in-built exporter which can quickly export detections to;
...
To get started, you can load the package and read in a PAMGuard binary file like so:
...
-   [**GitHub**](https://github.com/TaikiSan21/PamBinaries).
...
MATLAB code for opening PAMGuard binary files is on the [PAMGuard GitHub repository](https://github.com/PAMGuard/PAMGuardMatlab).

Download the [latest release](https://github.com/PAMGuard/PAMGuardMatlab/releases). Alternatively, you can clone the repository, which will make it easier to get updates if the code is updated.
...
clear
% the path to the binary file folder
...
-   [**GitHub**](https://github.com/PAMGuard/PAMGuardMatlab)
-   [**Zenodo**](https://doi.org/10.5281/zenodo.16979861)

## Python

PAMGuard [binary file](./olhelp/utilities/BinaryStore/docs/binarystore_overview.html) output can be read in Python using the **pypamguard** package.
