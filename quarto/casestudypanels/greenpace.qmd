---
title: " PAMGuard and Greenpeace towed array"
image: gptowedimages/towed_array.jpg
listing-description: "<div>Greanpeace deployed their first towed hydrophone from the stern of MY Arctic Sunrise as part of the pole to pole campaign for ocean protection. PAMGuard was used to;<ul>
<li>Collect over 1,696 hours of acoustic recordings</li>
<li>Detect cetacean species in real time during the sruevty</li>
<li>Locate sperm whales for photo ID</li>
<li>Efficiently process tens of TBs of collected data</li>
<li>Provide open tools to create efficient analysis workflows, enabling research</li>
</ul></div>"
---
...
![Towed passive acoustic surveys running PAMGuard deployed on Greenpeace ships, including systematic surveys in the Carion-Clipperton zone and Hellenic trench, as well as opportunistic surveys for cetacean diversity assessment around the Saya de Malha bank and Vema Seamount](gptowedimages/towed_map.jpg){width="100%"}
...
![Dr. Kirsten Young deploying the towed hydrophone array from the stern of the *MY Arctic Sunrise.* Credit: Greenpeace International / D. Zalcman](gptowedimages/kirsten_towed.jpg){width="100%"}

With over 25 TB of acoustic data collected during the first pole to pole survey, researchers developed a streamlined workflow using PAMGuard to efficiently process large quantities of data collected with a towed hydrophone array (Webber et al., 2022). 
Since then, this workflow, with some tweaking here and there, has been applied to all the acoustic surveys conducted onboard Greenpeace ships.
...
Webber et al., 2025, 
Young et al., 2025), 
increasing the pool of knowledge which can be drawn upon to implement conservation measures, or push for further systematic survey effort in poorly studied regions.

![Acoustic monitoring station running PAMGuard, set up on the *SY Rainbow Warrior.*](gptowedimages/acoustic_setup.jpg){width="100%"}
...
![The MY Arctic Sunrise towing the hydrophone array in Antarctic waters. Credit: Greenpeace International / A. Trayler-Smith.](gptowedimages/towed_array.jpg){width="100%"}
