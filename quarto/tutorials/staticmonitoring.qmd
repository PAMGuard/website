...
The tutorial text is in [Introduction to static monitoring.pdf](https://github.com/PAMGuardLearning/Intro2Pamguard/releases/download/V2.02.13/Introduction.Sound.Traps.2024-v2-02-13.pdf). You will also need to download the accompanying dataset from Zenodo [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.19567834.svg)](https://doi.org/10.5281/zenodo.19567834)
