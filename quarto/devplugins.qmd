...
There are two types of PAMGuard module: [Core modules](coremodules.html) which are built into the main PAMGuard code and [plugin modules](pluginmodules.html) which are distributed separately. This page tells you how to prepare a [plugin module](pluginmodules.html) for PAMGuard.
