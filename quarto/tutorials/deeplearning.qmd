...
This tutorial is suitable for beginners with PAMGuard, however, the [Getting Started with PAMGuard](getstarted.qmd) and [Introduction to static monitoring](staticmonitoring.qmd) tutorials are recommended first.
