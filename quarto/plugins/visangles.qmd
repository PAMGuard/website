...
Calculated angles will be stored to the database and displayed on the map. Not that PG Version 2.02.10 has a bug in the map display, so upgrade to a later version.
